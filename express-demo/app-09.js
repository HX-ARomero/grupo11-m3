...
//	HTTP headers, that determines whether browsers block frontend JavaScript
//	code from accessing responses for cross-origin requests.

// El browser chequea que toda la información provenga del mismo sitio:
//  -> Mismo "protocolo"
//  -> Mismo "puerto"
//  -> Mismo "host"

// Si alguno no coincide -> Error de Cors
// CORS header 'Access-Control-Allow-Origin' missing
// Motivo: Hace falta la cabecera CORS 'Access-Control-Allow-Origin'

// Si vamos a utilizar información de otro orígen debemos agregar:
// Header -> que indique desde dónde vamos a consumir información.
...
app.use((req, res, next) => {
	// Un Cors NO ES MÁS QUE UN MIDDLEWARE!!!
